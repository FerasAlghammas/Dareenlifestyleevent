  ...
  return (
    ...
    <section className="hero">
        <div className="hero-overlay">
            ...
            <h1 className="fade-in">Welcome to <span>DAREEN</span> Lifestyle</h1>
            <p className="fade-in delay">Celebrating Moments with Elegance, Creativity & Joy</p>
            <a href="#graduation" className="hero-button fade-in delay-2">Explore Our Work</a>
            </div>
        </div>
    </section>
    ...
    <GallerySection
        ...
        images={['FoundingDay1.jpg', 'FoundingDay2.jpg', 'FoundingDay3.jpg', 'FoundingDay4.jpg', 'FoundingDay5.jpg', 'FoundingDay6.jpg', 'FoundingDay7.jpg', 'FoundingDay8.jpg', 'FoundingDay9.jpg', 'FoundingDay10.jpg', 'FoundingDay11.jpg', 'FoundingDay12.jpg']}
